...
/**
 * Class based on boolean values used to determine if the user is allowed to access certain areas of program
 * @author Piotrek
 *
 */
public class Permission {
	...
	public static void showDefaultAlert(){
		Alert alert = new Alert(AlertType.ERROR);
		alert.setTitle("Brak uprawnieñ");
		alert.setHeaderText("Nie mo¿na wykonaæ polecenia");
		alert.setContentText("Twoje konto nie posiada wystarczaj¹cych uprawnieñ, aby wykonaæ wskazane polecenie");
		alert.showAndWait();
	}
